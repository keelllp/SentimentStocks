...
try:
    ...
    # Create minimal test data (similar to what yfinance might return)
    ...
    print(f"[DEBUG] Test data has NaN: {stock_data.isna().any().any()}")
    ...
    if recommendation is None:
        ...
        print(f"Change %: {recommendation['price_prediction']['change_percent']:.2f}%")
